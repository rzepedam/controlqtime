<div class="row">
    <div class="col-md-12">
        <div class="pull-right">
            ...
            <input type="checkbox" name="default" id="default" data-plugin="switchery" data-color="#3949AB" {{ (Route::is('terms-and-obligatories.create')) ? null : $termAndObligatory->default }} />
        </div>
    </div>
</div>
<div class="row">
