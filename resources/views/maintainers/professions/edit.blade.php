...
<div class="panel">
    {{ Form::model($profession, array('route' => ['maintainers.professions.update', $profession], 'method' => 'PUT' )) }}
        ...
        <div class="panel-footer">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{ route('maintainers.professions.index') }}">Volver</a><button type="submit" class="btn btn-squared btn-success btn-lg waves-effect waves-light pull-right"><i class="fa fa-refresh"></i> Actualizar</button>
                </div>
            </div>
        </div>
