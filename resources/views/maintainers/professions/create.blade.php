...
@section('breadcumb')
    ...
    <li><a href="{{ route('professions.index') }}"><i class="fa fa-briefcase"></i> Profesiones</a></li>
...
@section('content')
    ...
    <div class="panel">
        ...
        {{ Form::open(array('route' => 'professions.store', 'method' => 'POST', 'id' => 'form-submit')) }}
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ route('professions.index') }}">Volver</a>
