...
@section('breadcumb')
    ...
    <li><a href="{{ route('type-certifications.index') }}"><i class="md-badge-check"></i> Certificaciones</a></li>
...
@section('content')
    ...
    <div class="panel">
        ...
        {{ Form::open(array('route' => 'type-certifications.store', 'method' => 'POST', 'id' => 'form-submit')) }}
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ route('type-certifications.index') }}">Volver</a>
