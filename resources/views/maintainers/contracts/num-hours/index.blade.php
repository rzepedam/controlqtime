...
@section('title_header') Listado de Nº de Horas
    <br />
    <a href="{{ route('maintainers.contracts.num-hours.create') }}" class="btn btn-primary waves-effect waves-light"><i class="fa fa-plus"></i> Crear Nuevo Nº de Horas</a>
@stop
...
@section('content')
    ...
    @include('maintainers.contracts.num-hours.partials.table')
...
@section('scripts')
    ...
    {{ Html::script('me/js/base/maintainers/contracts/num-hours/config_bootstrap_table.js') }}
