...
@section('breadcumb')
    ...
    <li><a href="{{ route('num-hours.index') }}"><i class="fa fa-clock-o"></i> Nº de Horas</a></li>
...
@section('content')
    ...
    <div class="panel">
        ...
        {{ Form::open(array('route' => 'num-hours.store', 'method' => 'POST', 'id' => 'form-submit')) }}
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ route('num-hours.index') }}">Volver</a>
