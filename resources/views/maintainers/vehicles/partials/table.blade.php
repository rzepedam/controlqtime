                    ...
                    @foreach($vehicles as $vehicle)
                        ...
                        <tr data-id="{{ $vehicle->id }}">
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('maintainers.vehicles.edit', $vehicle) }}" class="btn btn-squared btn-warning waves-effect waves-light mitooltip" title="Editar"><i class="fa fa-pencil"></i> </a>
