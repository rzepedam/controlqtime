<span id="legal_representative0">
    ...
    <div class="row">
        <div class="col-md-2">
            {{ Form::label('rut0', 'Rut') }} <i class="fa fa-info-circle mitooltip text-primary" title="Ingrese rut sin guión ni dígito verificador. Ej: 80900568"></i>
            {{ Form::text('rut0', null, ['class' => 'form-control']) }}
        </div>
        <div class="col-md-1">
			{{ Form::label('dv0', 'Dv') }}
            {{ Form::text('dv0', null, ['class' => 'form-control', 'disabled']) }}
        </div>
        <div class="col-md-3">
