...
@section('breadcumb')
    ...
    <li><a href="{{ route('type-specialities.index') }}"><i class="fa fa-wrench"></i> Especialidades</a></li>
...
@section('content')
    ...
    <div class="panel">
        ...
        {{ Form::open(array('route' => 'type-specialities.store', 'method' => 'POST', 'id' => 'form-submit')) }}
