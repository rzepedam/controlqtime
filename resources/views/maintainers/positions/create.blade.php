...
@section('breadcumb')
    ...
    <li><a href="{{ route('positions.index') }}"><i class="md-seat"></i> Cargos</a></li>
...
@section('content')
    ...
    <div class="panel">
        ...
        {{ Form::open(array('route' => 'positions.store', 'method' => 'POST', 'id' => 'form-submit')) }}
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ route('positions.index') }}">Volver</a>
