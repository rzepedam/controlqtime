                ...
                @foreach($type_professional_licenses as $type_professional_license)
                    <tr data-id="{{ $type_professional_license->id }}">
                        ...
                        <td class="text-center">
                            <a href="{{ route('maintainers.type-professional-licenses.edit', $type_professional_license) }}" class="btn btn-squared btn-success waves-effect waves-light mitooltip" title="Editar"><i class="fa fa-pencil"></i> </a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
