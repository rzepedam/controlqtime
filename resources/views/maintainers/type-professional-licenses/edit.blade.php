...
@section('content')
    ...
    <div class="panel">
        ...
        {{ Form::model($type_professional_license, array('route' => array('maintainers.type-professional-licenses.update', $type_professional_license), 'method' => 'PUT', 'id' => 'form-submit')) }}
