...
@section('breadcumb')
    ...
    <li><a href="{{ route('fuels.index') }}"><i class="md-gas-station"></i> Combustibles</a></li>
...
@section('content')
    ...
    <div class="panel">
        ...
        {{ Form::open(array('route' => 'fuels.store', 'method' => 'POST', 'id' => 'form-submit')) }}
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ route('fuels.index') }}">Volver</a>
