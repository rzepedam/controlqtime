                                ...
                                <div class="panel-body">
                                    <div id="content_studies">
                                        ...
                                        @if (count($manpower->studies) > 0)
                                            ...
                                            @include('human-resources.manpowers.partials.edit.step2.study')
                                ...
                                <div class="panel-body">
                                    <div id="content_certifications">
                                        ...
                                        @if (count($manpower->certifications) > 0)
                                            ...
                                            @include('human-resources.manpowers.partials.edit.step2.certification')
                                ...
                                <div class="panel-body">
                                    <div id="content_specialities">
                                        ...
                                        @if (count($manpower->specialities) > 0)
                                            ...
                                            @include('human-resources.manpowers.partials.edit.step2.speciality')
                                ...
                                <div class="panel-body">
                                    <div id="content_licenses">
                                        ...
                                        @if (count($manpower->professionalLicenses) > 0)
                                            ...
                                            @include('human-resources.manpowers.partials.edit.step2.professional_license')
                                ...
                                <div class="panel-body">
                                    <div id="content_disabilities">
                                        ...
                                        @if(count($manpower->disabilities) > 0)
                                            ...
                                            @include('human-resources.manpowers.partials.edit.step3.disability')
                                ...
                                <div class="panel-body">
                                    <div id="content_diseases">
                                        ...
                                        @if(count($manpower->diseases) > 0)
                                            ...
                                            @include('human-resources.manpowers.partials.edit.step3.disease')
                                ...
                                <div class="panel-body">
                                    <div id="content_exams">
                                        ...
                                        @if(count($manpower->exams) > 0)
                                            ...
                                            @include('human-resources.manpowers.partials.edit.step3.exams')
                                ...
                                <div class="panel-body">
                                    <div id="content_family_responsabilities">
                                        ...
                                        @if(count($manpower->familyResponsabilities) > 0)
                                            ...
                                            @include('human-resources.manpowers.partials.edit.step3.family_responsability')
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var count_family_relationships = {{ count($manpower->familyRelationships) }};
