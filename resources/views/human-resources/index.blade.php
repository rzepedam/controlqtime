...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-4 col-md-3">
            <div id="redirect-daily-assistances" class="counter counter-lg counter-inverse bg-teal-400 vertical-align waves-effect waves-block waves-light height-150 margin-bottom-5 pointer">
