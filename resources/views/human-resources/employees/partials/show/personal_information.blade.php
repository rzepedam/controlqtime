                ...
                <div class="table-responsive">
                    <div class="row">
                        ...
                        <div class="col-md-2" style="margin-top: 3px;">
                            <img src="https://s3-sa-east-1.amazonaws.com/biometry/faces/2016/06/29/172959168369.jpg" alt="{{ $employee->full_name }}" width="152" height="152" class="img-bordered img-bordered-primary">
                        </div>
                    </div>
                </div>
                <br/>
