<div class="panel">
    <div class="panel-body">
        ...
        <table class="table-hover table-condensed" id="master_form_piece_vehicle_table" data-mobile-responsive="true">
            <thead>
                <tr>
                    <th class="col-md-1" data-field="id" data-sortable="true">ID</th>
                    <th class="col-md-10" data-field="name" data-sortable="true">Nombre</th>
