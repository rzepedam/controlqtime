...
class CompanyRequest extends Request
{
	...
	public function rules()
	{
		switch ($this->method()) {
			...
			case 'PUT': {
				$company = Company::with([ 'legalRepresentative' ])->findOrFail($this->route->parameter('company'));
				...
				$rules = [
					...
					'phone1_representative' => 'required|max:20',
					'phone2_representative' => 'max:20',
					'email_representative'  => 'required|max:60|email|unique:legal_representatives,email_representative,' . $company->legalRepresentative->id,
				];
