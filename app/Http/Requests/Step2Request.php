...
class Step2Request extends Request
{
					...
					foreach ( range(0, request('count_studies') - 1) as $index )
					{
						...
						switch ( request('degree_id')[$index] )
						{
							case '3':
								...
								$rules['name_institution.' . $index] = 'required|max:80';
								break;
	...
	public function messages()
	{
		return [
			...
			'name_institution.0.required'             => 'El campo Nombre Institución 1 es obligatorio.',
			'name_institution.1.required'             => 'El campo Nombre Institución 2 es obligatorio.',
			'name_institution.2.required'             => 'El campo Nombre Institución 3 es obligatorio.',
			'name_institution.3.required'             => 'El campo Nombre Institución 4 es obligatorio.',
			'name_institution.4.required'             => 'El campo Nombre Institución 5 es obligatorio.',
			'name_institution.0.max'                  => 'El campo Nombre Institución 1 no debe ser mayor que 80 caracteres.',
			'name_institution.1.max'                  => 'El campo Nombre Institución 2 no debe ser mayor que 80 caracteres.',
			'name_institution.2.max'                  => 'El campo Nombre Institución 3 no debe ser mayor que 80 caracteres.',
			'name_institution.3.max'                  => 'El campo Nombre Institución 4 no debe ser mayor que 80 caracteres.',
			'name_institution.4.max'                  => 'El campo Nombre Institución 5 no debe ser mayor que 80 caracteres.',
