...
class EmployeeCreateLicenseTest extends BrowserKitTestCase
{
    ...
    public function test_store_with_professional_license_employee()
    {
        $this->sessionStep2 += [
    ...
    public function test_store_with_multiple_professional_license_employee()
    {
