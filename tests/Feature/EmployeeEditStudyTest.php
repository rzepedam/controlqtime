...
class EmployeeEditStudyTest extends BrowserKitTestCase
{
    ...
    public function test_update_with_detail_school_study_employee()
    {
    ...
    public function test_update_with_detail_technical_study_employee()
    {
        $this->step2_update += [
    ...
    public function test_update_with_detail_college_study_employee()
    {
