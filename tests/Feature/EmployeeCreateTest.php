...
class EmployeeCreateTest extends BrowserKitTestCase
{
    ...
    /** @test */
    public function store_with_contact_relationship_study_certification_speciality_license_disability_disease_exam_responsability_employee()
    {
        $this->sessionStep1 += [
            'id_contact'                 => [0],
