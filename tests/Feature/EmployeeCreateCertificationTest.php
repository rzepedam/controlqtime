...
class EmployeeCreateCertificationTest extends BrowserKitTestCase
{
    ...
    public function test_store_with_certification_employee()
    {
        $this->sessionStep2 += [
            'id_certification'             => [0],
    ...
    public function test_store_with_multiple_certification_employee()
    {
