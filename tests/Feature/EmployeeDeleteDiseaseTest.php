...
class EmployeeDeleteDiseaseTest extends BrowserKitTestCase
{
    ...
    public function test_delete_a_disease_employee()
    {
        $this->step3_update += [
    ...
    public function test_delete_than_one_disease_employee()
    {
    ...
    public function test_delete_than_one_disease_and_than_one_image_employee()
    {
        $typeDisease = factory(TypeDisease::class)->create();
