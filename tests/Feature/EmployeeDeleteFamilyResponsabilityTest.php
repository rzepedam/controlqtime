...
class EmployeeDeleteFamilyResponsabilityTest extends BrowserKitTestCase
{
    ...
    public function test_delete_a_family_responsability_employee()
    {
        $this->step3_update += [
    ...
    public function test_delete_than_one_family_responsability_employee()
    {
    ...
    public function test_delete_than_one_family_responsability_and_than_one_image_employee()
    {
        $relationship = factory(Relationship::class)->create();
