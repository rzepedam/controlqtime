...
class EmployeeCreateSpecialityTest extends BrowserKitTestCase
{
    ...
    public function test_store_with_speciality_employee()
    {
        $this->sessionStep2 += [
            'id_speciality'             => [0],
    ...
    public function test_store_with_multiple_speciality_employee()
    {
