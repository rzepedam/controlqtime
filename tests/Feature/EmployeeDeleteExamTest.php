...
class EmployeeDeleteExamTest extends BrowserKitTestCase
{
    ...
    public function test_delete_a_exam_employee()
    {
        $this->step3_update += [
    ...
    public function test_delete_than_one_exam_employee()
    {
    ...
    public function test_delete_than_one_exam_and_than_one_image_employee()
    {
        $typeExam = factory(TypeExam::class)->create();
