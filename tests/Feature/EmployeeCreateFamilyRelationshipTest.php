...
class EmployeeCreateFamilyRelationshipTest extends BrowserKitTestCase
{
    ...
    public function test_store_with_family_relationship_employee()
    {
        $this->sessionStep1 += [
    ...
    public function test_store_with_multiple_family_relationship_employee()
    {
