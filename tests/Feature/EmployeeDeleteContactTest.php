...
class EmployeeDeleteContactTest extends BrowserKitTestCase
{
    ...
    /** @test */
    public function delete_a_contact_employee()
    {
    ...
    /** @test */
    public function delete_more_than_one_contacts_employee()
    {
