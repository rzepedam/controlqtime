...
class EmployeeDeleteDisabilityTest extends BrowserKitTestCase
{
    ...
    public function test_delete_a_disability_employee()
    {
        $this->step3_update += [
    ...
    public function test_delete_a_disability_and_image_employee()
    {
        $image = factory(\Controlqtime\Core\Entities\Image::class)->create([
            'imageable_id'   => $this->disability->id,
            'imageable_type' => 'Controlqtime\Core\Entities\Disability',
        ]);
    ...
    public function test_delete_than_one_disability_employee()
    {
    ...
    public function test_delete_than_one_disability_and_than_one_image_employee()
    {
        $typeDisability = factory(TypeDisability::class)->create();
