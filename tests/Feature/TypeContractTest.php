...
class TypeContractTest extends BrowserKitTestCase
{
	...
	/** @test */
	function create_new_type_contract_plazo_fijo()
	{
	...
	/** @test */
	function dont_create_new_type_contract_plazo_fijo()
	{
		$this->visit('/maintainers/type-contracts/create')
			->select('Plazo Fijo', 'name')
			->type('', 'dur')
	...
	/** @test */
	function create_new_type_contract_indefinido()
	{
		$this->visit('/maintainers/type-contracts/create')
	...
	/** @test */
	function edit_url_type_contract()
	{
	...
	/** @test */
	function see_correct_default_values_in_edit()
	{
		$this->visit('/maintainers/type-contracts/' . $this->typeContract->id . '/edit')
