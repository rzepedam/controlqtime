...
class EmployeeDeleteSpecialityTest extends BrowserKitTestCase
{
    ...
    public function test_delete_a_speciality_employee()
    {
    ...
    public function test_delete_a_speciality_and_image_employee()
    {
    ...
    public function test_delete_than_one_speciality_employee()
    {
    ...
    public function test_delete_than_one_speciality_and_than_one_image_employee()
    {
        $institution = factory(Institution::class)->create();
        $typeSpeciality = factory(TypeSpeciality::class)->create();
