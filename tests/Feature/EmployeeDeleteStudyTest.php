...
class EmployeeDeleteStudyTest extends BrowserKitTestCase
{
    ...
    public function test_delete_a_school_study_employee()
    {
    ...
    public function test_delete_than_one_school_study_employee()
    {
    ...
    public function test_delete_a_technical_study_employee()
    {
    ...
    public function test_delete_than_one_technical_study_employee()
    {
    ...
    public function test_delete_a_college_study_employee()
    {
    ...
    public function test_delete_than_one_college_study_employee()
    {
