...
class TermAndObligatoryEditTest extends BrowserKitTestCase
{
    ...
    public function test_edit_term_and_obligatory()
    {
    ...
    public function test_dont_update_term_and_obligatory_when_name_is_empty()
    {
    ...
    public function test_update_name_in_term_and_obligatory()
    {
    ...
    public function test_update_default_in_term_and_obligatory()
    {
        $this->visit('maintainers/terms-and-obligatories/'.$this->term->id.'/edit')
            ->check('default')
            ->press('Actualizar')
