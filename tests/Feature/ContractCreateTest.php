...
class ContractCreateTest extends BrowserKitTestCase
{
    ...
    /** @test */
    public function start_contract_is_required()
    {
    ...
    /** @test */
    public function start_contract_must_be_d_m_Y_format()
    {
        $this->json('POST', 'human-resources/contracts', [
            'company_id'       => $this->companyA->id,
            'employee_id'      => $this->employee->id,
    ...
    /** @test */
    public function num_hour_should_not_be_less_than_1()
    {
        $this->json('POST', 'human-resources/contracts', [
            'company_id'       => $this->companyA->id,
            'employee_id'      => $this->employee->id,
    ...
    /** @test */
    public function num_hour_must_be_grater_than_45()
    {
        $this->json('POST', 'human-resources/contracts', [
            'company_id'       => $this->companyA->id,
            'employee_id'      => $this->employee->id,
