...
class SignInVisitTest extends TestCase
{
	...
	/** @test */
	function can_formatted_rut_sign_in_visit()
	{
	...
	/** @test */
	function can_formatted_birthday_sign_in_visit()
	{
	...
	/** @test */
	function can_formatted_is_male_to_M_sign_in_visit()
	{
		$signInVisit = factory(\Controlqtime\Core\Entities\SignInVisit::class)->create([
			'is_male' => 'M'
		]);
	...
	/** @test */
	function can_formatted_is_male_to_F_sign_in_visit()
	{
		$signInVisit = factory(\Controlqtime\Core\Entities\SignInVisit::class)->create([
			'is_male' => 'F'
		]);
	...
	/** @test */
	function can_display_birthday_to_d_m_Y_format_sign_in_visit()
	{
		$signInVisit = factory(\Controlqtime\Core\Entities\SignInVisit::class)->create([
			'birthday' => '16-09-2005'
		]);
	...
	/** @test */
	function can_display_birthday_to_spanish_format_sign_in_visit()
	{
		$signInVisit = factory(\Controlqtime\Core\Entities\SignInVisit::class)->create([
			'birthday' => '23-01-2017'
		]);
