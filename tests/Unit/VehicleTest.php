...
class VehicleTest extends BrowserKitTestCase
{
    ...
    public function test_get_acquisition_date_to_spanish_format_vehicle()
    {
    ...
    public function test_get_inscription_date_to_spanish_format_vehicle()
    {
        $vehicle = factory(\Controlqtime\Core\Entities\Vehicle::class)->states('enable')->create([
    ...
    public function test_get_created_at_to_spanish_format_vehicle()
    {
        $vehicle = factory(\Controlqtime\Core\Entities\Vehicle::class)->states('enable')->create([
    ...
    public function test_get_date_documentation_to_d_m_Y_format_vehicle()
    {
