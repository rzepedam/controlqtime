...
class TypeVehicleWithTrashedTest extends TestCase
{
	...
	function test_edit_type_vehicle_when_weight_is_deleted()
	{
	...
	function test_edit_type_vehicle_when_engine_cubic_is_deleted()
	{
	...
	function test_edit_type_vehicle_when_weight_and_engine_cubic_is_deleted()
	{
		$this->delete('maintainers/measuring-units/weights/' . $this->typeVehicle->weight->id);
		$this->delete('maintainers/measuring-units/engine-cubics/' . $this->typeVehicle->engineCubic->id);
