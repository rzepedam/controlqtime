...
class EmployeeDeleteCertificationTest extends TestCase
{
	...
	function test_delete_a_certification_and_image_employee()
	{
	...
	function test_delete_than_one_certification_employee()
	{
	...
	function test_delete_than_one_certification_and_than_one_image_employee()
	{
		$institution       = factory(Institution::class)->create();
		$typeCertification = factory(TypeCertification::class)->create();
