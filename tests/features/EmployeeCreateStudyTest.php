...
class EmployeeCreateStudyTest extends TestCase
{
	...
	function test_store_with_detail_school_study_employee()
	{
	...
	function test_store_with_multiple_detail_school_study_employee()
	{
	...
	function test_store_with_detail_technical_study_employee()
	{
	...
	function test_store_with_multiple_detail_technical_study_employee()
	{
		$degreeTechnical = factory(Degree::class)->create(['id' => 3]);
	...
	function test_store_with_detail_college_study_employee()
	{
	...
	function test_store_with_multiple_detail_college_study_employee()
	{
	...
	function test_store_with_multiple_detail_study_employee()
	{
		$degreeSchool    = factory(Degree::class)->create(['id' => 2]);
		$degreeTechnical = factory(Degree::class)->create(['id' => 3]);
		$degreeCollege   = factory(Degree::class)->create(['id' => 8]);
