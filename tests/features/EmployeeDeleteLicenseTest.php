...
class EmployeeDeleteLicenseTest extends TestCase
{
	...
	function test_delete_a_license_and_image_employee()
	{
	...
	function test_delete_than_one_license_employee()
	{
	...
	function test_delete_than_one_license_and_than_one_image_employee()
	{
		$typeProfessionalLicense = factory(TypeProfessionalLicense::class)->create();
